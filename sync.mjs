/**
 * sync.mjs — one command to update both destinations:
 *   1. build:forge  ? forge.inerate.com/atelier/docs  ? forge-site/public/atelier/docs
 *   2. build        ? inerate.github.io/atelier/docs  ? inerate.github.io/atelier/docs
 */
