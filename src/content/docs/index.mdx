...
The agent **cannot claim "finished"** while one criterion is unmet — the loop engine
refuses to terminate. Review gates (design tokens, file budgets, ponytail, graph
impact) verify each one with evidence.

Next: [Install & first project](/docs/start/install/).
